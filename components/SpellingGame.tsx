        ...
        <div className="flex flex-wrap justify-center gap-2 min-h-[60px] mb-8 p-4 bg-slate-50 rounded-xl border-2 border-dashed border-slate-200" dir="ltr">
           {selectedLetters.map((letter) => (
             <button
               ...
               className={`w-10 h-12 sm:w-12 sm:h-14 flex items-center justify-center text-2xl font-bold rounded-lg shadow-sm border-b-4 transition-all active:scale-95 ${
                 gameStatus === 'correct' 
