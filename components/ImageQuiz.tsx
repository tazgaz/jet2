      ...
      <div className="bg-white rounded-3xl shadow-xl p-4 border-b-8 border-indigo-200">
        ...
        <div className="h-14 flex items-center justify-center">
             {isAnswered ? (
                 ...
                 className={`w-full flex items-center justify-center gap-3 px-6 py-3 rounded-2xl font-bold text-white shadow-lg transition-all hover:scale-105 active:scale-95 ${
                     selectedOption === correctAnswer?.english ? 'bg-green-500 hover:bg-green-600' : 'bg-slate-800 hover:bg-slate-900'
                 }`}
                 >
